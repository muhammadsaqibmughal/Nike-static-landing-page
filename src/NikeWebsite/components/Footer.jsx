    ...
    <footer className='max-container'>
                  ...
                  <ul>
                    {
                      section.links.map((link)=>(
                        <li key={link.name} className='mt-3 font-montserrat text-base text-white hover:text-slate-gray cursor-pointer'>
                          <a href="">{link.name}</a>
                        </li>
                      ))
                    }
      ...
      <div className='flex justify-between mt-24 text-white-400 max-sm:flex-col max-sm:items-center'>
          <div className='flex flex-1 justify-start items-center gap-2 font-montserrat cursor-pointer'>
            <img src={copyrightSign} alt="copy right icon" width={20} height={20} className='rounded-full m-0' />
